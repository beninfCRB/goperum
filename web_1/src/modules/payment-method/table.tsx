...
export interface tablePaymentMethodProps {
...
interface stateTablePaymentMethod {
...
const TablePaymentMethod = (props: tablePaymentMethodProps) => {
    const [_state, setState] = useState<stateTablePaymentMethod | null>(null)
    ...
    const columns: ColumnsType<PaymentMethodType> = [
        {
            key: 'code',
            title: 'Kode',
            dataIndex: 'code',
