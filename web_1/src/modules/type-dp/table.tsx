...
export interface tableTypeDPProps {
    data: Array<TypeDPType>;
    onLoading: boolean;
    onEdit: (id: string) => void;
    onDelete: (id: string) => void;
}

interface stateTableTypeDP {
...
const TableTypeDP = (props: tableTypeDPProps) => {
    const [_state, setState] = useState<stateTableTypeDP | null>(null)
    ...
    const columns: ColumnsType<TypeDPType> = [
        {
            key: 'code',
            title: 'Kode',
            dataIndex: 'code',
