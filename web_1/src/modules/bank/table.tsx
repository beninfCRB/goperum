...
export interface tableBankProps {
    data: Array<BankType>;
    onLoading: boolean;
...
const TableBank = (props: tableBankProps) => {
    const [_state, setState] = useState<stateTableBank | null>(null)
    ...
    const columns: ColumnsType<BankType> = [
        {
            key: 'code',
            title: 'Kode',
            dataIndex: 'code',
