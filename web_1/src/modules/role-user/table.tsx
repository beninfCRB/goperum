...
export interface tableRoleUserProps {
    data: Array<RoleUserType>;
    onLoading: boolean;
    onEdit: (id: string) => void;
    onDelete: (id: string) => void;
}

interface stateTableRoleUser {
...
const TableRoleUser = (props: tableRoleUserProps) => {
    const [_state, setState] = useState<stateTableRoleUser | null>(null)
    ...
    const columns: ColumnsType<RoleUserType> = [
        {
            key: 'code',
            title: 'Kode',
            dataIndex: 'code',
